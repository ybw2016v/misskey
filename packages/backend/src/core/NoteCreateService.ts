...
export class NoteCreateService implements OnApplicationShutdown {
	...
	private async pushToTl(note: MiNote, user: { id: MiUser['id']; host: MiUser['host']; }) {
		...
		if (note.channelId) {
			...
			this.fanoutTimelineService.pushexist(`userTimelineWithChannel:${user.id}`, note.id, note.userHost == null ? this.meta.perLocalUserUserTimelineCacheMax : meta.perRemoteUserUserTimelineCacheMax, r);
			...
			for (const channelFollowing of channelFollowings) {
				...
				this.fanoutTimelineService.pushexist(`homeTimeline:${channelFollowing.followerId}`, note.id, this.meta.perUserHomeTimelineCacheMax, r);
				if (note.fileIds.length > 0) {
					...
					this.fanoutTimelineService.pushexist(`homeTimelineWithFiles:${channelFollowing.followerId}`, note.id, this.meta.perUserHomeTimelineCacheMax / 2, r);
			...
			for (const following of followings) {
				...
				this.fanoutTimelineService.pushexist(`homeTimeline:${following.followerId}`, note.id, this.meta.perUserHomeTimelineCacheMax, r);
				...
				if (note.fileIds.length > 0) {
					...
					this.fanoutTimelineService.pushexist(`homeTimelineWithFiles:${following.followerId}`, note.id, this.meta.perUserHomeTimelineCacheMax / 2, r);
			...
			for (const userListMembership of userListMemberships) {
				...
				this.fanoutTimelineService.pushexist(`userListTimeline:${userListMembership.userListId}`, note.id, this.meta.perUserListTimelineCacheMax, r);
				...
				if (note.fileIds.length > 0) {
					...
					this.fanoutTimelineService.pushexist(`userListTimelineWithFiles:${userListMembership.userListId}`, note.id, this.meta.perUserListTimelineCacheMax / 2, r);
				}
			}
			...
			if (note.userHost == null) {
				...
				this.fanoutTimelineService.pushexist(`homeTimeline:${user.id}`, note.id, this.meta.perUserHomeTimelineCacheMax, r);
					if (note.fileIds.length > 0) {
						// this.fanoutTimelineService.push(`homeTimelineWithFiles:${user.id}`, note.id, this.meta.perUserHomeTimelineCacheMax / 2, r);
					this.fanoutTimelineService.pushexist(`homeTimelineWithFiles:${user.id}`, note.id, this.meta.perUserHomeTimelineCacheMax / 2, r);
					}
				}
			}
			...
			if (isReply(note)) {
				...
				this.fanoutTimelineService.pushexist(`userTimelineWithReplies:${user.id}`, note.id, note.userHost == null ? this.meta.perLocalUserUserTimelineCacheMax : this.meta.perRemoteUserUserTimelineCacheMax, r);
				...
				this.fanoutTimelineService.pushexist(`userTimeline:${user.id}`, note.id, note.userHost == null ? this.meta.perLocalUserUserTimelineCacheMax : this.meta.perRemoteUserUserTimelineCacheMax, r);
				if (note.fileIds.length > 0) {
					...
					this.fanoutTimelineService.pushexist(`userTimelineWithFiles:${user.id}`, note.id, note.userHost == null ? this.meta.perLocalUserUserTimelineCacheMax / 2 : this.meta.perRemoteUserUserTimelineCacheMax / 2, r);
				}
