...
export class UserEntityService implements OnModuleInit {
	...
	public async pack<S extends 'MeDetailed' | 'UserDetailedNotMe' | 'UserDetailed' | 'UserLite' = 'UserLite'>(
		...
		const packed = {
			...
			host: user.host,
			avatarUrl: (!user.host || me) ? ((user.avatarId == null ? null : user.avatarUrl) ?? this.getIdenticonUrl(user)) : this.getIdenticonUrl(user),
			...
			...(isDetailed ? {
				...
				bannerUrl: (!user.host || me) ? (user.bannerId == null ? null : user.bannerUrl) : null,
